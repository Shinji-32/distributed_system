...
class LoggingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LogMessage = channel.unary_unary(
                '/messages.LoggingService/LogMessage',
                request_serializer=messages__pb2.LogRequest.SerializeToString,
                response_deserializer=messages__pb2.LogResponse.FromString,
                _registered_method=True)
        self.GetMessages = channel.unary_unary(
                '/messages.LoggingService/GetMessages',
...
def add_LoggingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'LogMessage': grpc.unary_unary_rpc_method_handler(
                    servicer.LogMessage,
                    request_deserializer=messages__pb2.LogRequest.FromString,
                    response_serializer=messages__pb2.LogResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'messages.LoggingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('messages.LoggingService', rpc_method_handlers)
...
class LoggingService(object):
    ...
    def LogMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/messages.LoggingService/LogMessage',
            messages__pb2.LogRequest.SerializeToString,
            messages__pb2.LogResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
